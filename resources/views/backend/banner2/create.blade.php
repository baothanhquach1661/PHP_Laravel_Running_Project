...
@section('title', 'Tạo mới banner adv')
@section('admin')
            ...
            <div class="row row-sm">
				<div class="col-lg-9 col-xl-9 col-md-12 col-sm-12">
					<div class="card box-shadow-0">
						<div class="card-body">
							<form method="post" action="{{ route('banner2.store') }}" enctype="multipart/form-data" class="form-horizontal">
								@csrf
								...
								<div class="form-group">
									<label for="title" class="form-label">Image (1600x600)</label>
									<input type="file" name="banner_photo" class="form-control" id="image">
									@if($errors->has('banner_photo'))
									       <div class="error" style="color: red;">{{ $errors->first('banner_photo') }}</div>
									@endif
								</div>
								<div class="form-group">
