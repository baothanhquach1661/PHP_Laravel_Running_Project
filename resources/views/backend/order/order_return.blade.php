...
@section('title', 'Đơn hàng đang chờ xử lý yêu cầu')
@section('admin')
            ...
            <div class="page-header">
                <div class="ms-auto pageheader-btn">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Return Orders Management</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header border-bottom">
							<h3 class="card-title">Đơn hàng đang chờ xử lý yêu cầu hoàn trả lại ( {{ count($orders) }} )</h3>
						</div>
						<div class="card-body">
									...
									<tbody>
										@foreach($orders as $data)
											<tr>
												...
												<td>
													<a href="{{ route('return.approve', $data->id) }}" class="btn btn-info" id="approve">
														Xác nhận
													</a>
												</td>
											</tr>
