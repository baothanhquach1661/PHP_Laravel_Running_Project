            ...
            <div class="page-header">
                <div class="ms-auto pageheader-btn">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Picked Orders Management</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header border-bottom">
							<h3 class="card-title">Quản lý tất cả đơn hàng đã soạn xong ( {{ count($orders) }} )</h3>
						</div>
						<div class="card-body">
										...
										@foreach($orders as $data)
											<tr>
												...
												<td>
													...
													@else
														<span class="badge bg-danger" style="font-size: 12px;">Đang đợi xử lý</span>
													@endif
												</td>
												<td>
													<a href="{{ route('pending-order.edit', $data->id) }}" class="btn btn-info">Cập nhật</a>
													<a href="{{ route('picked-shipped', $data->id) }}" class="btn btn-dark" id="shipped">Gửi đi</a>
												</td>
											</tr>
										@endforeach
									</tbody>
