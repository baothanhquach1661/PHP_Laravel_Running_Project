...
@section('title', 'Đơn hàng đã hoàn tất')
@section('admin')
            ...
            <div class="page-header">
                <div class="ms-auto pageheader-btn">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Delivered Orders Management</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header border-bottom">
							<h3 class="card-title">Quản lý tất cả đơn hàng đã hoàn tất ( {{ count($orders) }} )</h3>
						</div>
						<div class="card-body">
									...
									<tbody>
										@foreach($orders as $data)
											<tr>
												...
												<td>
													<a href="{{ route('pending-order.edit', $data->id) }}" class="btn btn-dark">View</a>
