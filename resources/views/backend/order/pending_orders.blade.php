...
@section('title', 'Đơn hàng đang chờ xử lý')
@section('admin')
            ...
            <div class="page-header">
                <div class="ms-auto pageheader-btn">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Pending Orders Management</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header border-bottom">
							<h3 class="card-title">Quản lý tất cả đơn hàng đang chờ xử lý ( {{ count($orders) }} )</h3>
						</div>
						<div class="card-body">
