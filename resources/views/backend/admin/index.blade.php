...
@php
    ...
    $picked_orders = App\Models\Order::where('status', 'Picked')->get();

    $customer_messages = App\Models\CustomerMessage::where('status', 1)->get();
@endphp
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-semibold">{{ count($pending_orders) }}</h3>
                                    <p class="text-muted fs-13 mb-0">Đơn hàng đang chờ xử lý</p>
                                </div>
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-semibold">{{ count($customer_messages) }}</h3>
                                    <p class="text-muted fs-13 mb-0">Tin nhắn khách hàng</p></p>
                                </div>
                                <div class="col col-auto top-icn dash">
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-semibold">{{ number_format($today) }}₫</h3>
                                    <p class="text-muted fs-13 mb-0">Today's sale</p>
                                    <p class="text-muted mb-0 mt-2 fs-12"></p>
                                </div>
                                <div class="col col-auto top-icn dash">
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-semibold">{{ number_format($month) }}₫</h3>
                                    <p class="text-muted fs-13 mb-0">Monthly sale</p></p>
                                </div>
                                <div class="col col-auto top-icn dash">
                                    <div class="counter-icon bg-secondary dash ms-auto box-shadow-secondary">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-white" enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M19.5,7H16V5.9169922c0-2.2091064-1.7908325-4-4-4s-4,1.7908936-4,4V7H4.5C4.4998169,7,4.4996338,7,4.4993896,7C4.2234497,7.0001831,3.9998169,7.223999,4,7.5V19c0.0018311,1.6561279,1.3438721,2.9981689,3,3h10c1.6561279-0.0018311,2.9981689-1.3438721,3-3V7.5c0-0.0001831,0-0.0003662,0-0.0006104C19.9998169,7.2234497,19.776001,6.9998169,19.5,7z M9,5.9169922c0-1.6568604,1.3431396-3,3-3s3,1.3431396,3,3V7H9V5.9169922z M19,19c-0.0014038,1.1040039-0.8959961,1.9985962-2,2H7c-1.1040039-0.0014038-1.9985962-0.8959961-2-2V8h3v2.5C8,10.776123,8.223877,11,8.5,11S9,10.776123,9,10.5V8h6v2.5c0,0.0001831,0,0.0003662,0,0.0005493C15.0001831,10.7765503,15.223999,11.0001831,15.5,11c0.0001831,0,0.0003662,0,0.0006104,0C15.7765503,10.9998169,16.0001831,10.776001,16,10.5V8h3V19z"></path></svg>
                ...
                {{-- <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-semibold">{{ number_format($year) }}₫</h3>
                                    <p class="text-muted fs-13 mb-0">Year Sale</p>
                                </div>
                                <div class="col col-auto top-icn dash">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header border-bottom">
                            <h3 class="card-title">Có {{ count($pending_orders) }} đang chờ xử lý</h3>
                        </div>
                        <div class="card-body">
                                        ...
                                        @foreach($pending_orders as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('pending-order.delete', $data->id) }}" class="btn btn-danger" id="delete"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
