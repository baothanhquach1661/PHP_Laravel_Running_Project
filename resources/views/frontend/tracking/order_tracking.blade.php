    ...
    <div class="container" style="margin-bottom: 100px; margin-top: 50px;">
        <article class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{ url('/') }}" class="axil-btn btn-bg-primary" data-abc="true"> <i class="fa fa-chevron-left"></i>Trở về trang chủ</a>
            </div>
        </article>
